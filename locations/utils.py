...
from locations.models import LocationAttribute, LocationChangeLog, Location
...
def update_map_json():
    ...
    file_path = base_dir + os.getenv("GOODMAP_PATH_TO_JSON")
    try:
        ...
        # Сохраняем JSON файл в корневую директорию проекта
