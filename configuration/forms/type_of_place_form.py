...
class TypeOfPlaceCreateForm(forms.ModelForm):
    ...
    class Meta:
        model = TypeOfPlace
        fields = ['name', 'attributes', 'enable_website', 'website', 'enable_comments', 'comments']
    ...
    def clean(self):
        ...
        elif not enable_comments:
            cleaned_data['comments'] = None  # Clear comments if not enabled
